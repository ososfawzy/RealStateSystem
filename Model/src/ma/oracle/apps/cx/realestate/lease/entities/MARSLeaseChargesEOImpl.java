...
// ---    Tue May 01 16:49:24 EEST 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MARSLeaseChargesEOImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        ChargeId {
            public Object get(MARSLeaseChargesEOImpl obj) {
                return obj.getChargeId();
            }

            public void put(MARSLeaseChargesEOImpl obj, Object value) {
        ...
        public abstract Object get(MARSLeaseChargesEOImpl object);

        public abstract void put(MARSLeaseChargesEOImpl object, Object value);
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("ma.oracle.apps.cx.realestate.lease.entities.MARSLeaseChargesEO");
        }
    ...
    /**
     * @param chargeId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Number chargeId) {
        return new Key(new Object[]{chargeId});
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        setChargeId(seq.getSequenceNumber());
