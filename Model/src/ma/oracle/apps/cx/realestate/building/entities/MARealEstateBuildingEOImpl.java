...
// ---    Thu Dec 13 12:32:31 EET 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MARealEstateBuildingEOImpl extends EntityImpl {
    /**
     * AttributesEnum: generated enum for identifying attributes and accessors. DO NOT MODIFY.
     */
    public enum AttributesEnum {
        BuildingId {
            public Object get(MARealEstateBuildingEOImpl obj) {
                return obj.getBuildingId();
            }

            public void put(MARealEstateBuildingEOImpl obj, Object value) {
        ...
        public abstract Object get(MARealEstateBuildingEOImpl object);

        public abstract void put(MARealEstateBuildingEOImpl object, Object value);
     ...
     */
    public MARealEstateBuildingEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("ma.oracle.apps.cx.realestate.building.entities.MARealEstateBuildingEO");
    }
    ...
    /**
     * Gets the attribute value for BuildingName, using the alias name BuildingName.
     * @return the value of BuildingName
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for BuildingName.
     * @param value value to set the BuildingName
     */
    ...
    /**
     * Gets the attribute value for BuildingLocation, using the alias name BuildingLocation.
     * @return the value of BuildingLocation
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for BuildingLocation.
     * @param value value to set the BuildingLocation
     */
    ...
    /**
     * Gets the attribute value for BuildingType, using the alias name BuildingType.
    ...
    /**
     * Sets <code>value</code> as the attribute value for BuildingType.
     * @param value value to set the BuildingType
     */
    ...
    /**
     * Gets the attribute value for BuildingSubType, using the alias name BuildingSubType.
     * @return the value of BuildingSubType
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for BuildingSubType.
     * @param value value to set the BuildingSubType
     */
    ...
    /**
     * Gets the attribute value for StartServiceDate, using the alias name StartServiceDate.
     * @return the value of StartServiceDate
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for StartServiceDate.
     * @param value value to set the StartServiceDate
     */
    ...
    /**
     * Gets the attribute value for EndServiceDate, using the alias name EndServiceDate.
     * @return the value of EndServiceDate
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for EndServiceDate.
     * @param value value to set the EndServiceDate
     */
     ...
     * @return the value of AvailableForRentFlag
     */
    ...
    /**
     * Gets the attribute value for RentOption, using the alias name RentOption.
     * @return the value of RentOption
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for RentOption.
     * @param value value to set the RentOption
     */
     ...
     * @return the value of ServiceStartDate
     */
     ...
     * @param value value to set the ServiceStartDate
     */
     ...
     * @return the value of ServiceEndDate
     */
     ...
     * @param value value to set the ServiceEndDate
     */
    ...
    /**
     * Gets the attribute value for GroundArea, using the alias name GroundArea.
     * @return the value of GroundArea
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for GroundArea.
     * @param value value to set the GroundArea
     */
    ...
    /**
     * Gets the attribute value for GroundPricePerMeter, using the alias name GroundPricePerMeter.
     * @return the value of GroundPricePerMeter
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for GroundPricePerMeter.
     * @param value value to set the GroundPricePerMeter
     */
     ...
     * @return the value of NoOfFloors
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for Boundries.
    ...
    /**
     * Gets the attribute value for NorthSide, using the alias name NorthSide.
     * @return the value of NorthSide
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for NorthSide.
     * @param value value to set the NorthSide
     */
    ...
    /**
     * Gets the attribute value for SouthSide, using the alias name SouthSide.
     * @return the value of SouthSide
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for SouthSide.
     * @param value value to set the SouthSide
     */
    ...
    /**
     * Gets the attribute value for WestSide, using the alias name WestSide.
     * @return the value of WestSide
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for WestSide.
     * @param value value to set the WestSide
     */
    ...
    /**
     * Gets the attribute value for EastSide, using the alias name EastSide.
     * @return the value of EastSide
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for EastSide.
     * @param value value to set the EastSide
     */
    ...
    /**
     * @param buildingId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Number buildingId) {
        return new Key(new Object[] { buildingId });
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        SequenceImpl seq =
            new SequenceImpl("XXMA.XXMA_REAL_ESTATE_BUILDING_SEQ", getDBTransaction());
        setBuildingId(seq.getSequenceNumber());
        setIntAttribute10("XXMA_REAL_ESTATE_BUILDING");
    }
