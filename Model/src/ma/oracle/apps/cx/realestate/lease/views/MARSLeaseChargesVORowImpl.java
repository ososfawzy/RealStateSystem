...
import ma.oracle.apps.cx.realestate.lease.entities.MARSLeaseChargesEOImpl;
...
// ---------------------------------------------------------------------
public class MARSLeaseChargesVORowImpl extends ViewRowImpl {

    public static final int ENTITY_MARSLEASECHARGESEO = 0;
    ...
    public enum AttributesEnum {
        Amount {
            public Object get(MARSLeaseChargesVORowImpl obj) {
                return obj.getAmount();
            }

            public void put(MARSLeaseChargesVORowImpl obj, Object value) {
        ...
        MAChargesTypeVVO {
            public Object get(MARSLeaseChargesVORowImpl obj) {
                return obj.getMAChargesTypeVVO();
            }
        ...
        ,
        MARSLeasePropertiesChargesLOVVVO {
            public Object get(MARSLeaseChargesVORowImpl obj) {
                return obj.getMARSLeasePropertiesChargesLOVVVO();
            }
        ...
        public abstract Object get(MARSLeaseChargesVORowImpl object);

        public abstract void put(MARSLeaseChargesVORowImpl object,
                                 Object value);
    ...
    public static final int MACHARGESTYPEVVO = AttributesEnum.MAChargesTypeVVO.index();
    public static final int MARSLEASEPROPERTIESCHARGESLOVVVO = AttributesEnum.MARSLeasePropertiesChargesLOVVVO.index();

    /**
     * This is the default constructor (do not remove).
     */
    public MARSLeaseChargesVORowImpl() {
    }

    /**
     * Gets MARSLeaseChargesEO entity object.
     * @return the MARSLeaseChargesEO
     */
    public MARSLeaseChargesEOImpl getMARSLeaseChargesEO() {
        return (MARSLeaseChargesEOImpl)getEntity(0);
    }
    ...
    public String getPropertySegment() {
        ...
        if (this.getPropertyId() != null && this.getLeaseId() != null) {
            ...
            vo.executeQuery();
            if (vo != null)
                return (String)vo.first().getAttribute("PropertyCode");
            else
                return null;
        } else {
            return null;
    ...
    /**
     * Gets the view accessor <code>RowSet</code> MAChargesTypeVVO.
     */
    public RowSet getMAChargesTypeVVO() {
        return (RowSet)getAttributeInternal(MACHARGESTYPEVVO);
    }

    /**
     * Gets the view accessor <code>RowSet</code> MARSLeasePropertiesChargesLOVVVO.
     */
    public RowSet getMARSLeasePropertiesChargesLOVVVO() {
        return (RowSet)getAttributeInternal(MARSLEASEPROPERTIESCHARGESLOVVVO);
    }
