...
// ---    Tue May 01 17:11:53 EEST 2018
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class MARSLeasePaymentsEOImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        PaymentId {
            public Object get(MARSLeasePaymentsEOImpl obj) {
                return obj.getPaymentId();
            }

            public void put(MARSLeasePaymentsEOImpl obj, Object value) {
        ...
        public abstract Object get(MARSLeasePaymentsEOImpl object);

        public abstract void put(MARSLeasePaymentsEOImpl object, Object value);
    ...
    public static final int PAYMENTNUMBER =
        AttributesEnum.PaymentNumber.index();
    ...
    public static final int PAYMENTSTATUS =
        AttributesEnum.PaymentStatus.index();
    public static final int REMARKS = AttributesEnum.Remarks.index();
    public static final int CONTRACTREFRENCE =
        AttributesEnum.ContractRefrence.index();
    public static final int ISDELETEDFLAG =
        AttributesEnum.IsDeletedFlag.index();
    ...
    public static final int EXTATTRIBUTECATEGORY =
        AttributesEnum.ExtAttributeCategory.index();
    public static final int EXTATTRIBUTE1 =
        AttributesEnum.ExtAttribute1.index();
    public static final int EXTATTRIBUTE2 =
        AttributesEnum.ExtAttribute2.index();
    public static final int EXTATTRIBUTE3 =
        AttributesEnum.ExtAttribute3.index();
    public static final int EXTATTRIBUTE4 =
        AttributesEnum.ExtAttribute4.index();
    public static final int EXTATTRIBUTE5 =
        AttributesEnum.ExtAttribute5.index();
    public static final int EXTATTRIBUTE6 =
        AttributesEnum.ExtAttribute6.index();
    public static final int EXTATTRIBUTE7 =
        AttributesEnum.ExtAttribute7.index();
    public static final int EXTATTRIBUTE8 =
        AttributesEnum.ExtAttribute8.index();
    public static final int EXTATTRIBUTE9 =
        AttributesEnum.ExtAttribute9.index();
    public static final int EXTATTRIBUTE10 =
        AttributesEnum.ExtAttribute10.index();
    public static final int EXTATTRIBUTE11 =
        AttributesEnum.ExtAttribute11.index();
    public static final int EXTATTRIBUTE12 =
        AttributesEnum.ExtAttribute12.index();
    public static final int EXTATTRIBUTE13 =
        AttributesEnum.ExtAttribute13.index();
    public static final int EXTATTRIBUTE14 =
        AttributesEnum.ExtAttribute14.index();
    public static final int EXTATTRIBUTE15 =
        AttributesEnum.ExtAttribute15.index();

    /**
     * This is the default constructor (do not remove).
     */
    public MARSLeasePaymentsEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject =
                    EntityDefImpl.findDefObject("ma.oracle.apps.cx.realestate.lease.entities.MARSLeasePaymentsEO");
        }
    ...
    /**
     * Gets the attribute value for RemitToBank, using the alias name RemitToBank.
     * @return the RemitToBank
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for RemitToBank.
     * @param value value to set the RemitToBank
     */
    ...
    /**
     * Gets the attribute value for ContractRefrence, using the alias name ContractRefrence.
     * @return the ContractRefrence
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for ContractRefrence.
     * @param value value to set the ContractRefrence
     */
    ...
    /**
     * @param paymentId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Number paymentId) {
        return new Key(new Object[] { paymentId });
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        SequenceImpl seq =
            new SequenceImpl("XXMA.XXMA_RS_LEASE_PAYMENTS_SEQ", getDBTransaction());
        setPaymentId(seq.getSequenceNumber());
